...
class Layers
{
    ...
    static void Main()
    {
        ...
        // Create three layers
        int oc1 = LumasPdf.pdfCreateOCGW(pdf, "All", true, true, LumasPdfConsts.oiAll);
        int oc2 = LumasPdf.pdfCreateOCGW(pdf, "Text and Annotations", true, true, LumasPdfConsts.oiAll);
        int oc3 = LumasPdf.pdfCreateOCGW(pdf, "Images", true, true, LumasPdfConsts.oiAll);
