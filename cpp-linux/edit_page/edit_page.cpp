...
int main(int argc, char** argv){
    ...
    pdfEditPage(pdf, 1);
        ...
        std::string s =
            ...
            "\\LD[12]Although it is possible to correct the coordinate origin manually, it is much easier to set the property SetUseVisibleCoords() to true. DynaPDF moves the zero point then automatically into the visible area of the page.\r\r"
