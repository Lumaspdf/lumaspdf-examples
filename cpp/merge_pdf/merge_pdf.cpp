...
int main(int argc, char** argv){
    ...
    pdfAppend(pdf);
        ...
        pdfWriteFTextExW(pdf, 50.0, 50.0, pdfGetPageWidth(pdf) - 100.0, -1.0, taJustify,
            ...
            (LWCHAR*)(LUMAS_TEXT("The following pages were imported from different PDF files. LumasPDF adjusts the destinations of link annotations and bookmarks so that ")
    ...
    std::string files[2] = { LUMAS_REPO_ROOT "/license.pdf", LUMAS_REPO_ROOT "/sample_multipage.pdf" };
