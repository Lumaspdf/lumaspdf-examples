...
int main(int argc, char** argv){
    ...
    SI32 oc1 = pdfCreateOCGW(pdf, (LWCHAR*)LUMAS_TEXT("All"), 0, 1, oiAll);
    SI32 oc2 = pdfCreateOCGW(pdf, (LWCHAR*)LUMAS_TEXT("Text and Annotations"), 0, 1, oiAll);
    SI32 oc3 = pdfCreateOCGW(pdf, (LWCHAR*)LUMAS_TEXT("Images"), 0, 1, oiAll);

    void* root = pdfAddLayerToDisplTreeW(pdf, nullptr, oc1, (LWCHAR*)LUMAS_TEXT("A layer group with a title"));
    void* grp  = pdfAddLayerToDisplTreeW(pdf, root, -1, (LWCHAR*)LUMAS_TEXT(""));
    pdfAddLayerToDisplTreeW(pdf, grp, oc2, (LWCHAR*)LUMAS_TEXT(""));
    pdfAddLayerToDisplTreeW(pdf, grp, oc3, (LWCHAR*)LUMAS_TEXT(""));
    ...
    pdfBeginLayer(pdf, oc2);
        ...
        SI32 annot = pdfWebLinkW(pdf, 50.0, 51.0, tw, 12.0, (LWCHAR*)LUMAS_TEXT("www.lumaspdf.com"));
