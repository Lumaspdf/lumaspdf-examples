...
Option Explicit
' ============================================================================
'  font_substitution -- Native C API DLL wrapper style (wrappers/vb6), ZERO wrapper modules.
...
'  substitution. The UTF-16LE text is read via ADODB.Stream and laid out with
'  the wide WriteFTextExW. Enums come from the typelib.
' ============================================================================
