...
'  explicit arg). Imports every page of dynapdf_help.pdf as a template and lays
...
' Table flag not exposed by the type library (from dynapdf.pas):
...
' pdf.RaiseExceptions = True
    ...
    pdf.OpenImportFile App.Path & "\..\..\..\..\dynapdf_help.pdf", ptOpen, ""
