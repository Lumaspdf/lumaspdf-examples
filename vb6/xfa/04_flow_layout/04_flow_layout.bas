Attribute VB_Name = "mod04FlowLayout"
Option Explicit
' ============================================================================
'  04_flow_layout -- VB6 port of the LumasPDF XFA "flavor tour" example 4 of
'  10: FLOW LAYOUT (layout="tb" / layout="lr-tb"). Native C API DLL wrapper
'  style (wrappers\vb6\CPDF.cls), ZERO extra wrapper modules -- same
'  convention as every other examples\Vb6\* driver in this project.
'
'  "TermsPanel" (tb) stacks 6 clauses vertically with zero gap; "SkillsPanel"
'  (lr-tb) packs 9 tags left-to-right, wrapping across 3 lines. All layout
'  math happens inside the engine during pdfRenderXFAForm; this driver just
'  drives the same real-DLL pipeline every other example in the tour uses.
'
'  Mirrors examples\delphi\xfa\04_flow_layout\04_flow_layout.dpr's call
...
'  04_flow_layout.template.xml / .datasets.xml as raw bytes -- no XML
'  parsing needed.
' ============================================================================
...
Public Sub Main()
    ...
    Debug.Print "=== 04_flow_layout.xdp -> 04_flow_layout.pdf ==="

    LoadFileBytes App.Path & "\04_flow_layout.template.xml", templateBuf, haveTemplate
    LoadFileBytes App.Path & "\04_flow_layout.datasets.xml", datasetsBuf, haveDatasets
    ...
    outFile = App.Path & "\04_flow_layout.pdf"
    ...
    Debug.Print "RESULT|04_flow_layout=" & pages
End Sub
