Attribute VB_Name = "mod03FormcalcCalculations"
Option Explicit
' ============================================================================
'  03_formcalc_calculations -- VB6 port of the LumasPDF XFA "flavor tour"
'  example 3 of 10: FORMCALC CALCULATIONS. Native C API DLL wrapper style
'  (wrappers\vb6\CPDF.cls), ZERO extra wrapper modules -- same convention as
'  every other examples\Vb6\* driver in this project.
'
'  Exercises the XFA FormCalc VM end-to-end (11 real v1 builtins: Sum, Avg,
'  Round, Count, If, Concat, Upper, Left, Date2Num, Num2Date, DateFmt, plus
'  *, -, >= operators) through <calculate> scripts on an "Order Calculator"
'  form -- all evaluation happens inside the engine during pdfRenderXFAForm;
'  this driver just drives the same real-DLL pipeline every other example in
'  the tour uses.
'
'  Mirrors examples\delphi\xfa\03_formcalc_calculations\03_formcalc_calculations.dpr's
...
'  03_formcalc_calculations.template.xml / .datasets.xml as raw bytes -- no
'  XML parsing needed.
' ============================================================================
...
Public Sub Main()
    ...
    Debug.Print "=== 03_formcalc_calculations.xdp -> 03_formcalc_calculations.render.pdf ==="

    LoadFileBytes App.Path & "\03_formcalc_calculations.template.xml", templateBuf, haveTemplate
    LoadFileBytes App.Path & "\03_formcalc_calculations.datasets.xml", datasetsBuf, haveDatasets
    ...
    outFile = App.Path & "\03_formcalc_calculations.render.pdf"
    ...
    Debug.Print "RESULT|03_formcalc_calculations=" & pages
End Sub
