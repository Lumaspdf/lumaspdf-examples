...
Option Explicit
' ============================================================================
'  render_page -- Native C API DLL wrapper style (wrappers/vb6), ZERO wrapper modules.
'  Early-bound to the wrappers/vb6 native modules (CPDF / LumasPDFInt) (one Reference in the .vbp).
'  The GUI on-screen rasterizer (CreateRasterizer/RenderPage) is not exposed;
'  this mirrors the achievable core: import the first page of a PDF and render
