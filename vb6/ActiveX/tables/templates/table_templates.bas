...
'  reference, not modified). Imports every page of sample_multipage.pdf as a
'  template and lays them two per row in a table (tfScaleToRect), then draws
'  the table across as many output pages as needed.
' ============================================================================

' Table flag not exposed by a type library reference (from LumasPdf.pas):
...
Public Sub Main()
    ...
    pdf.OpenImportFileA App.path & "\..\..\..\..\..\sample_multipage.pdf", ptOpen, ""
