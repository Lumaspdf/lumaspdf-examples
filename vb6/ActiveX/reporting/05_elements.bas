...
' ===========================================================================
'  ActiveX/COM mirror of examples\Vb6\reporting\05_elements.bas.
'  Same feature: every element kind (text/line/shape/image/barcode/
'  subreport) on one page, through pdf.Rpt* COM methods. The tiny 8x8 BMP
'  and the subreport .lrpt are still generated at runtime, not copied
'  static assets.
' ===========================================================================
...
Public Sub Main()
    ...
    Xml = Xml & "   <text name=""title"" x=""0"" y=""0"" w=""180"" h=""10"" fontSize=""18"" hAlign=""center"">Every Element Kind (ActiveX)</text>" & vbLf
...
ErrHandler:
    ...
    MsgBox "Failed: " & Err.Description & extra, vbCritical, "05_elements (ActiveX)"
End Sub
