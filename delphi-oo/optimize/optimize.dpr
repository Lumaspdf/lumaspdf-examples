program optimize;
// Delphi OO example -- imports a PDF, runs Optimize() and writes the result.
{$APPTYPE CONSOLE}
uses
  System.SysUtils,
  LumasPdf,
...
function OptimizeFile(pdf: TPDF; const InFile, OutFile: AnsiString): Boolean;
var
  i, n: Integer;
  e: TPDFError;
begin
