  ...
  try
    ...
    pdf.EditPage(1);
      ...
      s := 'It is not difficult to edit an imported page but two things must be considered:'#13#13 +
           ...
           'LumasPDF moves the zero point then automatically into the visible area of the page.'#13#13 +
      ...
      pdf.WriteFTextExA(50.0, 200.0, pdf.GetPageWidth - 100.0, -1.0, taJustify, PAnsiChar(s));
    pdf.EndPage;
