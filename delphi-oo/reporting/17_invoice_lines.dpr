...
// ===========================================================================
//  LumasReport OO example 17 -- Invoice with comprehensive LINE usage,
//  exported to MULTIPLE formats (PDF, HTML, SVG, TEXT, CSV, XLSX, XLS).
//  OO port: boots via TPDF (see _oo_shared.inc). Demonstrates the full ekLine
//  surface (orientation / scope / alignment / dash / double / stroke / colour /
//  cap) + inline aggregates SUM(Qty*Price).
// ===========================================================================
{$APPTYPE CONSOLE}
uses
