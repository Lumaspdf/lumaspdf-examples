' migration_states -- VB.NET port of examples\Vb6\annotations\migration_states
Imports System
Imports System.IO
Imports LumasPdfSdk

Module MigrationStates
    ...
    Sub Main()
        ...
        reply = LumasPdf.pdfSetAnnotMigrationStateW(pdf, annot, TAnnotState.asCompleted, "Harry")
        LumasPdf.pdfSetAnnotStringW(pdf, reply, TAnnotString.asContent, "The state was set to Completed!")

        reply = LumasPdf.pdfSetAnnotMigrationStateW(pdf, reply, TAnnotState.asAccepted, "Jim")
        LumasPdf.pdfSetAnnotStringW(pdf, reply, TAnnotString.asContent, "The state was set to Accepted!")
