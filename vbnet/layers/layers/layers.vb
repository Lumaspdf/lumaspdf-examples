' layers -- VB.NET port of examples\Vb6\layers\layers
Imports System
...
Module modLayers
    ...
    Sub Main()
        ...
        Dim oc1 As Integer = LumasPdf.pdfCreateOCGW(pdf, "All", True, True, CUInt(LumasPdfConsts.oiAll))
        Dim oc2 As Integer = LumasPdf.pdfCreateOCGW(pdf, "Text and Annotations", True, True, CUInt(LumasPdfConsts.oiAll))
        Dim oc3 As Integer = LumasPdf.pdfCreateOCGW(pdf, "Images", True, True, CUInt(LumasPdfConsts.oiAll))
