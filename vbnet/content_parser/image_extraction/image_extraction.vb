...
Module ImageExtraction
    ...
    Sub Main()
        ...
        Dim inFile As String = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..\..\..\..\sample_multipage.pdf")
        If LumasPdf.pdfOpenImportFileW(pdf, inFile, LumasPdfConsts.ptOpen, "") < 0 Then
            Console.WriteLine("Input file ""sample_multipage.pdf"" not found!")
