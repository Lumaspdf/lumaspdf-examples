...
// Merges license.pdf and dynapdf_help.pdf, adjusting destinations on import.
{$APPTYPE CONSOLE}
uses
  ...
  try
    ...
    pdf.Append;
      ...
      pdf.WriteFTextExA(50.0, 50.0, pdf.GetPageWidth - 100.0, -1.0, Integer(taJustify),
        'The following pages were imported from different PDF files. DynaPDF adjusts the destinations of link annotations and bookmarks so that '#13#13 +
