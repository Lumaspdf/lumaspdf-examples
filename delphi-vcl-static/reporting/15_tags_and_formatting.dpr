...
// ===========================================================================
//  LumasReport PURE-VCL STATIC example 15 -- {{ }} tag language + text formatting
//  Static build: engine linked in (LUMAS_STATIC), NO LumasPdf.dll. Exercises
//  every v1 interpolation form + the text-formatting knobs, then proves (by
//  exporting to TEXT and grepping) that the interpolations resolved.
