...
begin
  ...
  try
    ...
    PlaceEMFCentered(f1, pdf.GetPageWidth, pdf.GetPageHeight);
    pdf.EndPage;

    pdf.Append; pdf.SetOrientationEx(90);
    PlaceEMFCentered(f2, pdf.GetPageWidth, pdf.GetPageHeight);
    pdf.EndPage;

    pdf.Append; pdf.SetOrientationEx(90);
    PlaceEMFCentered(f3, pdf.GetPageWidth, pdf.GetPageHeight);
    pdf.EndPage;
