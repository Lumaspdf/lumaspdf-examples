...
begin
   ...
   // If the zoom factor is large then LumasPDF falls back into zoom mode and this mode works with the
...
begin
   // If the PDFCanvas was not able to load the LumasPdf.dll, i.e. when it finds a wrong version, then it sets
