...
begin
   ...
   try
      ...
      pdf.WriteFText(taLeft, 'This is a PDF/A 1b compatible PDF file that was digitally signed with '
         ...
         +'returns 0, LumasPDF assumes that the prior changes were accepted and processing continues.'#13#13
      ...
      // Note that the CMYK profile is just an example profile that can be delivered with the classic API.
