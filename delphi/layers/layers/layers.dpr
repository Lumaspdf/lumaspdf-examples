...
var annot, ocmd, oc1, oc2, oc3: Integer; tw: double; pdf: TPDF; outFile, someText: String; ocArray: Array[0..1] of Cardinal;
begin
   pdf := nil;
   try
      pdf := TPDF.Create;
      ...
      // Create three layers
      oc1 := pdf.CreateOCG('All', true, true, oiAll);
      oc2 := pdf.CreateOCG('Text and Annotations', true, true, oiAll);
      oc3 := pdf.CreateOCG('Images', true, true, oiAll);
