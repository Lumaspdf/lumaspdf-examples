...
const ALT_FONTS: Array[0..4] of WideString =
(
...
procedure TestAlternateFonts;
var pdf: TPDF; txt: WideString; altFonts: Integer; outFile: String;
begin
   pdf := nil;
   ...
   try
      ...
      pdf.SetAltFonts(altFonts, @ALT_FONTS, 5);
