# ============================================================================
#  annotation_replies -- Python (ctypes) port of
#  examples\Vb6\annotations\annotation_replies\annotation_replies.bas
...
def main():
    ...
    reply = L.pdfSetAnnotMigrationStateA(pdf, annot, L.asCreateReply, b"Harry")
    L.pdfSetAnnotStringA(pdf, reply, L.asContent, b"This is a reply!")

    reply = L.pdfSetAnnotMigrationStateA(pdf, reply, L.asCreateReply, b"Jim")
    L.pdfSetAnnotStringA(pdf, reply, L.asContent, b"This is a reply to a reply!")
    L.pdfEndPage(pdf)
