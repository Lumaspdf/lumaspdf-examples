...
def main():
    ...
    intro = ("The following pages were imported from different PDF files. LumasPDF adjusts the destinations of link annotations and bookmarks so that "
    ...
    files = [os.path.join(here, "license.pdf"), os.path.join(here, "sample_multipage.pdf")]
