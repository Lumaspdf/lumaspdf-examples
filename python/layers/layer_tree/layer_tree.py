# ============================================================================
#  layer_tree -- Python (ctypes) port of examples\Vb6\layers\layer_tree\layer_tree.bas
#  Creates three optional-content groups arranged in a display tree with a titled
#  group, and adds text (with a web link) and an image to the layers.
# ============================================================================
import os
import sys
import ctypes
...
def main():
    ...
    oc1 = L.pdfCreateOCGA(pdf, b"All", 0, 1, L.oiAll)
    oc2 = L.pdfCreateOCGA(pdf, b"Text and Annotations", 0, 1, L.oiAll)
    oc3 = L.pdfCreateOCGA(pdf, b"Images", 0, 1, L.oiAll)

    root = L.pdfAddLayerToDisplTreeA(pdf, 0, oc1, b"A layer group with a title")
    grp = L.pdfAddLayerToDisplTreeA(pdf, root, -1, b"")
    L.pdfAddLayerToDisplTreeA(pdf, grp, oc2, b"")
    L.pdfAddLayerToDisplTreeA(pdf, grp, oc3, b"")
