...
# ============================================================================
#  render_page_ex -- Python (ctypes) port of
#  examples\Vb6\rendering_engine\render_page_ex
...
SRC_PDF = _here('sample_multipage.pdf')
CMAP_DIR = _here('')
...
def main():
    ...
    outFile = os.path.join(HERE, "render_page_ex.tif")
