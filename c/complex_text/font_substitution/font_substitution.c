/* ============================================================================
 *  font_substitution -- C (x64) port of the VB6 mirror
 *  examples\Vb6\complex_text\font_substitution\font_substitution.bas
 *  Complex text layout of a multi-language text relying on automatic font
 *  substitution. Text loaded as UTF-16 and laid out with WriteFTextEx() (wide).
 * ========================================================================== */
#include <stdio.h>
#include <string.h>
#include <math.h>
...
int main(int argc, char** argv)
{
    ...
    /* No bidi mode: rely on automatic font substitution. */
